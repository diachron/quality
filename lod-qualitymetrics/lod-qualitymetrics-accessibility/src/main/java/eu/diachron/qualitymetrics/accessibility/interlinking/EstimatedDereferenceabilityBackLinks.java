 ...
 * 
 */
public class EstimatedDereferenceabilityBackLinks implements QualityMetric {
	
	private final Resource METRIC_URI = DQM.DereferenceabilityBackLinksMetric;
	
	final static Logger logger = LoggerFactory.getLogger(EstimatedDereferenceabilityBackLinks.class);
	...
	*/
	...
	public static void setReservoirSize(int reservoirSize) {
		EstimatedDereferenceabilityBackLinks.reservoirSize = reservoirSize;
	}
