...
public abstract class EvolutionQualityMetric {
	...
	public abstract void compute(); //hrysakis NOTE: here compute method does not contain any argument
	// could have as arguments the compaired old and new version...
