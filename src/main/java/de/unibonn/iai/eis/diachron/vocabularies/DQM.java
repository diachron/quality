 ...
 * @author Auto-generated by schemagen on 26 sep 2014 12:20 
 */
public class DQM {
    ...
    /** <p>Links Verifiability Dimension with Identity Information Provider Metric</p> */
    public static final Property hasAuthenticityDatasetMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasAuthenticityDatasetMetric" );
    ...
    /** <p>Links Trust Category with Believability Dimension</p> */
    public static final Property hasBelievabilityDimension = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasBelievabilityDimension" );
    
    /** <p>Links Believability Dimension with BlackListing Metric</p> */
    public static final Property hasBlackListingMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasBlackListingMetric" );
    ...
    /** <p>Links Relevancy Dimension with Coverage Metric</p> */
    public static final Property hasCoverageMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasCoverageMetric" );
    ...
    /** <p>Links Verifiability Dimension with digital signature Metric</p> */
    public static final Property hasDigitalSignatureMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasDigitalSignatureMetric" );
    ...
    /** <p>Links Believability Dimension with Identity Information Provider Metric ( 
     *  Identity Information Provider Metric belongs to the Believability Dimension)</p>
     */
    public static final Property hasIdentityInformationProviderMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasIdentityInformationProviderMetric" );
    ...
    /** <p>Links Trust Category with Objectivity Dimension</p> */
    public static final Property hasObjectivityDimension = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasObjectivityDimension" );
    ...
    /** <p>Links Believability Dimension with Provenance Information Metric</p> */
    public static final Property hasProvenanceInformationMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasProvenanceInformationMetric" );
    ...
    /** <p>Links Contextual Category with Relevancy Dimension</p> */
    public static final Property hasRelevancyDimension = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasRelevancyDimension" );
    
    /** <p>Links Relevancy Dimension with Relevant Terms Withing Meta Information Metric</p> */
    public static final Property hasRelevantTermsWithinMetaInformationMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasRelevantTermsWithinMetaInformationMetric" );
    ...
    /** <p>Links Trust Category with Reputation Dimension</p> */
    public static final Property hasReputationDimension = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasReputationDimension" );
    
    /** <p>Links Reputation Dimension with Reputation Metric</p> */
    public static final Property hasReputationMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasReputationMetric" );
    ...
    /** <p>Links Believability Dimension with Trustworthiness of the RDF statement Metric</p> */
    public static final Property hasTrustworthinessRDFStatementMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasTrustworthinessRDFStatementMetric" );
    
    /** <p>Links Consistency Dimension with Undefined classes or properties metric</p> */
    public static final Property hasUndefinedClassesOrPropertiesMetric = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasUndefinedClassesOrPropertiesMetric" );
    ...
    /** <p>Links Trust Category with Verifiability Dimension</p> */
    public static final Property hasVerifiabilityDimension = m_model.createProperty( "http://www.diachron-fp7.eu/dqm#hasVerifiabilityDimension" );
    ...
    /** <p>Verifying authenticity of the dataset based on a provenance vocabulary such 
     *  as the author and his contributors, the publisher of the data and its sources 
     *  if any</p>
     */
    public static final Resource AuthenticityDatasetMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#AuthenticityDatasetMetric" );
    ...
    /** <p>Refers to the degree in which the information is accepted to be correct, true, 
     *  real and credible</p>
     */
    public static final Resource Believability = m_model.createResource( "http://www.diachron-fp7.eu/dqm#Believability" );
    
    /** <p>Assesses whether the provider/contributor is contained in a list of blacklisted 
     *  providers</p>
     */
    public static final Resource BlackListingMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#BlackListingMetric" );
    ...
    /** <p>Assesses if the terms of a document contain the level of detail defined by 
     *  the administrator</p>
     */
    public static final Resource CoverageMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#CoverageMetric" );
    ...
    /** <p>Assesses if document contain a RDF serialization or signing an RDF graph</p> */
    public static final Resource DigitalSignatureMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#DigitalSignatureMetric" );
    ...
    /** <p>Assesses whether the provider/contributor is contained in a list of trusted 
     *  providers</p>
     */
    public static final Resource IdentityInformationProviderMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#IdentityInformationProviderMetric" );
    ...
    /** <p>Refers to the degree in which the interpretation and usage of data is unbiased, 
     *  unprejudiced and impartial</p>
     */
    public static final Resource Objectivity = m_model.createResource( "http://www.diachron-fp7.eu/dqm#Objectivity" );
    ...
    /** <p>Assesses if document contain information related with the provenance of the 
     *  information</p>
     */
    public static final Resource ProvenanceInformationMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#ProvenanceInformationMetric" );
    ...
    public static final Resource Relevance = m_model.createResource( "http://www.diachron-fp7.eu/dqm#Relevance" );
    
    /** <p>the extent to which information is applicable and helpful for the task at 
     *  hand</p>
     */
    public static final Resource Relevancy = m_model.createResource( "http://www.diachron-fp7.eu/dqm#Relevancy" );
    
    /** <p>Assesses if document contain detecting relevant terms</p> */
    public static final Resource RelevantTermsWithinMetaInformationMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#RelevantTermsWithinMetaInformationMetric" );
    ...
    /** <p>Refers to integrity of the data source that is determined by a user</p> */
    public static final Resource Reputation = m_model.createResource( "http://www.diachron-fp7.eu/dqm#Reputation" );
    
    /** <p>By assigning explicit ratings to the dataset</p> */
    public static final Resource ReputationMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#ReputationMetric" );
    ...
    /** <p>Assesses if document contain information related with the trustworthiness 
     *  of the information</p>
     */
    public static final Resource TrustworthinessRDFStatementMetric = m_model.createResource( "http://www.diachron-fp7.eu/dqm#TrustworthinessRDFStatementMetric" );
    ...
    /** <p>Refers to the degree by which a data consumer can assess the correctness of 
     *  a dataset</p>
     */
    public static final Resource Verifiability = m_model.createResource( "http://www.diachron-fp7.eu/dqm#Verifiability" );
