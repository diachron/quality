...
public class RLBSBloomFilter {
	...
	public static void main(String[] args) {
		RLBSBloomFilter bf = new RLBSBloomFilter(11, 500, 0.01);
		
		String[] testStream = new String[] {
				"Muchos años después, frente al pelotón de fusilamiento,", 
				"el coronel Aureliano Buendía había de recordar ",
				"aquella tarde remota en que su padre lo llevó a ",
				"conocer el hielo. Macondo era entonces una aldea ",
				...
				"gitanos desarrapados plantaba su carpa cerca de la aldea,",
				"el coronel Aureliano Buendía había de recordar ",
				"el coronel Aureliano Buendía había de recordar ",
				"mencionarlas había que señalarías con el dedo",
				"Todos los años, por el mes de marzo, una familia de ", 
				"el coronel Aureliano Buendía había de recordar ",
				"precipitaban por un lecho de piedras pulidas, blancas ", 
				"y enormes como huevos prehistóricos. El mundo era tan "
		};
		
		for(String str : testStream) {
			bf.checkDuplicate(str);
		}
	}
}
