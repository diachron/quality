...
public class HumanReadableLicenseTest extends Assert {
	
	private static Logger logger = LoggerFactory.getLogger(HumanReadableLicenseTest.class);
	
	protected TestLoader loaderPositive = new TestLoader();
	protected TestLoader loaderNegative = new TestLoader();
	
	protected HumanReadableLicense metricPositive = new HumanReadableLicense();
	protected HumanReadableLicense metricNegative = new HumanReadableLicense();
	...
	public void testHumanReadableLicense() {
		...
		logger.trace("Computed Human-readable license metric; positive case: {}, negative case: {}", metricValuePositve, metricValueNegative);
