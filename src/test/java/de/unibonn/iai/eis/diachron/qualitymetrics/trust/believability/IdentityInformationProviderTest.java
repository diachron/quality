...
public class IdentityInformationProviderTest extends Assert {

private static Logger logger = LoggerFactory.getLogger(IdentityInformationProviderTest.class);
	
	protected TestLoader loaderPositive = new TestLoader();
	protected TestLoader loaderNegative = new TestLoader();
	
	protected IdentityInformationProvider metricPositive = new IdentityInformationProvider();
	protected IdentityInformationProvider metricNegative = new IdentityInformationProvider();
	
	@Before
	public void setUp() throws Exception {
		loaderPositive.loadDataSet(DataSetMappingForTestCase.ResearchGroup);
	...
	public void testNegativeCase() {
		metricNegative = new IdentityInformationProvider();
